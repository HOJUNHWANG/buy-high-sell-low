...
export default function TermsPage() {
  return (
    <div className="legal-page max-w-3xl mx-auto px-5 py-12 space-y-8 text-gray-300">
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm leading-relaxed">
          ...
          completeness, or timeliness. Buy High Sell Low covers S&amp;P 100 stocks, core ETFs, and
          cryptocurrencies. Buy High Sell Low makes no guarantees about the reliability of market
